...
{
    class NodoBalanceado
    {
        //variables que manejan la posicion del elemento
        public NodoBalanceado Izquierda { get; set; }
        public NodoBalanceado Derecha { get; set; }
        ...
        public NodoBalanceado()
        {

        } 
        public NodoBalanceado(double dato)
        {
            ValorNodo = dato;
            f = 0;
            Izquierda = null;
        ...
        public NodoBalanceado(double dato, NodoBalanceado izq, NodoBalanceado der, NodoBalanceado padre)
        {   
          ValorNodo = dato;
          this.Izquierda = izq;
          this.Derecha = der;   
